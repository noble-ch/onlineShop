									...
									<Col className="mt-xl-3 mt-md-3 " sm lg xs md xl>
										...
										<Row>
											<Col
												...
												<h2 className="text-black-50 ">50+</h2>
												<h5 className="text-black-50">items</h5>
											</Col>
											<Col
												style={{
													color: "#3e3e3e"
												...
												<h2 className="text-black-50">100+</h2>
												<h5 className="text-black-50">Costumers</h5>
											</Col>
										</Row>
										<SearchBox />
									</Col>
								...
								{products.slice(0, 4).map((product) => (
									<Col
										...
										<Link id="product_name" to={`/product/${product._id}`}>
											...
											<p className="text-black-50 ">{product.price} (ETB)</p>
										</Link>
									</Col>
								))}
							</Row>
